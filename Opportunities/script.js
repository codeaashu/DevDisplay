fetch('https://opportunities-features.onrender.com/api/opportunities')
...
fetch('https://opportunities-features.onrender.com/api/opportunities/pending')
    .then(response => response.json())
    .then(data => {
...
function moderateOpportunity(id, status) {
    fetch(`https://opportunities-features.onrender.com/api/opportunities/${id}`, {
        method: 'PATCH',
        headers: {
            'Content-Type': 'application/json'
        },
