    ...
    <div className="my-7 w-full border-r-2 border-borderSecondary px-7 font-spaceMono dark:border-borderColor md:h-[90vh] md:w-[23%] md:px-2 lg:px-7">
      <div className="mb-2 flex h-12 items-center gap-2.5">
        ...
        <a href="https://devdisplay.vercel.app/">
          <div
            className="flex  text-[1.5rem] font-bold
           md:text-[1.05rem] lg:text-[1.25rem] min-[1200px]:text-[1.5rem] "
          >
      ...
      <div className="flex flex-row flex-wrap items-center justify-center gap-2 pt-6">
        ...
        {/* Button To star on Github */}
        <a href= "https://github.com/codeaashu/DevDisplay" target="_blank" rel="noreferrer">
        <button
          href="https://github.com/codeaashu/DevDisplay"
          class="flex overflow-hidden items-center text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-black text-white shadow hover:bg-black/90 h-9 my-4 px-4 py-2 max-w-52 whitespace-pre md:flex group relative w-full justify-center gap-2 rounded-md transition-all duration-300 ease-out hover:ring-2 hover:ring-black hover:ring-offset-2"
        >
