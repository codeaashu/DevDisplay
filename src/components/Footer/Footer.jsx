        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <style>
            {`
              ...
              .tooltip .tooltip-text::after {
                ...
                left: 50%;
                transform: translateX(-50%);
                border-width: 4px;      /* Slightly smaller arrow */
                border-style: solid;
          ...
          <div className="flex items-center justify-center space-x-6 md:justify-end">
            <a
              ...
              className="tooltip transform text-3xl transition-transform hover:scale-110 hover:text-[#6B7280]"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="tooltip transform text-3xl transition-transform hover:scale-110 hover:text-[#5865F2]"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="tooltip transform text-3xl transition-transform hover:scale-110 hover:text-[#0A66C2]"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="tooltip transform text-3xl transition-transform hover:scale-110 hover:text-[#000000]"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="tooltip transform text-3xl transition-transform hover:scale-110 hover:text-[#E1306C]"
            >
