    ...
    <StyledWrapper>
      <div className="modgp relative inline-block w-full py-3">
        <div className="relative">
          <button
            className="bg-primary enabled:hover:bg-primary-dark enabled:active:bg-primary-dark enabled:focus:bg-primary-dark relative inline-flex w-full items-center justify-center rounded-lg px-4 py-2 py-2.5 text-sm font-medium text-white transition-all focus:outline-none enabled:hover:shadow-md disabled:opacity-50"
            type="button"
          >
            <div className="flex w-full items-center justify-center">Let the Magic Begin</div>
          </button>
        </div>
