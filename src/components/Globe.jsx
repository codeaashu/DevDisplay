  ...
  useEffect(() => {
    ...
    const globe = createGlobe(canvasRef.current, {
      ...
      markers: [
        ...
        { location: [-14.2350, -51.9253], size: 0.1 }, // Brazil
        { location: [30.3753, 69.3451], size: 0.05 }, // Pakistan
        { location: [28.7041, 77.1025], size: 0.05 }, // Delhi
        { location: [19.0760, 72.8777], size: 0.05 }, // Maharashtra
        ...
        { location: [17.3850, 78.4867], size: 0.05 }, // Telangana
        ...
        { location: [15.2993, 74.1240], size: 0.05 }, // Goa
        ...
        { location: [15.9129, 79.7400], size: 0.05 }, // Andhra Pradesh
        ...
        { location: [28.3949, 84.1240], size: 0.05 }, // Nepal
        { location: [7.8731, 80.7718], size: 0.05 }, // Sri Lanka
        { location: [23.6850, 90.3563], size: 0.05 }, // Bangladesh
        { location: [33.9391, 67.7100], size: 0.05 }, // Afghanistan
        ...
        { location: [33.4484, -112.0740], size: 0.05 }, // Phoenix
