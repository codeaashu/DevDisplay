  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10 text-center">
        ...
        <p className="from-#0f766e-300 mt-4 flex items-center justify-center rounded-lg bg-gradient-to-r via-red-500 to-pink-500 p-4 text-lg text-white shadow-lg">
          <span role="img" aria-label="hurry up" className="mr-2 text-2xl">
