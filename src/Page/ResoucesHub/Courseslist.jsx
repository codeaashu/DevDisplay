...
const courses = [
  ...
  },
  {
    ...
    courseLink: 'https://namastedev.com/learn/namaste-javascript?_aff=946684862809',
  ...
  {
    platform: 'namastedev.com',
    title: 'Namaste React - English + Hindi',
    instructor: 'Akshay Saini',
    duration: 'n/a',
    level: 'Beginner',
    domain: ['Web Development', 'React', 'ReactJS', 'Frontend', 'Paid'],
    poster: '/assets/Courses/AkshaySainiNamasteReact.png',
    courseLink: 'https://namastedev.com/learn/namaste-react?_aff=946684862809',
    shareLink: '#reactjsbyakshaysaini',
  },
  {
    platform: 'namastedev.com',
    title: 'Namaste Frontend System Design - English + Hindi',
    instructor: 'Akshay Saini, Chirag Goel',
    duration: 'n/a',
    level: 'Beginner',
    domain: ['Web Development', 'Frontend', 'System Design', 'Paid'],
    poster: '/assets/Courses/AkshaySainiNamasteFrontendSystemDesign.png',
    courseLink: 'https://namastedev.com/learn/namaste-frontend-system-design?_aff=946684862809',
    shareLink: '#frontend-system-design-byakshaysaini',
  },
  {
    platform: 'YouTube',
